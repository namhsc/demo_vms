  ...
  return (
    <>
      <div className="min-h-screen bg-slate-950 flex flex-col">
        ...
        {/* Main Content */}
        <main className="flex-1 max-w-[1600px] mx-auto w-full flex flex-col overflow-hidden">
          {cameras.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-[60vh] text-slate-500 py-6">
              <Video className="w-24 h-24 mb-4" />
              <h2 className="text-xl mb-2">No Cameras Added</h2>
              <p className="text-sm">No cameras available</p>
            </div>
          ) : (
            <div className="grid grid-cols-12 gap-6 flex-1 min-h-0 px-6 py-6">
              {/* Camera List Sidebar */}
              <div className="col-span-3 flex flex-col gap-4 min-h-0">
                ...
                <Tabs
                  ...
                  className="w-full"
                >
                  <TabsList className="bg-slate-700/80 border border-slate-600/50 shadow-lg w-full">
                    <TabsTrigger
                      value="liveview"
                      className="text-slate-300 hover:text-white hover:bg-slate-600/50 data-[state=active]:bg-blue-600 data-[state=active]:text-white data-[state=active]:shadow-md data-[state=active]:font-semibold transition-all duration-200 flex-1"
                    >
              ...
              {/* Camera Grid */}
              <div className="col-span-9 bg-slate-800 rounded-xl flex flex-col min-h-0">
        ...
        <footer className="bg-slate-900 border-t border-slate-800 mt-auto">
          <div className="max-w-[1600px] mx-auto px-6 py-4">
            <div className="flex items-center justify-between text-sm text-slate-500">
              <div>© 2025 Hệ thống quản lý Camera</div>
            </div>
          </div>
        </footer>
        {/* <video
